// Runtime coverage for the spec 080 documentation-completeness schemas
...
describe("DocMemberId (spec 080 FR-001)", () => {
...
describe("BaseKeyboard.docProfile (spec 080 T033 — additive carrier field)", () => {
