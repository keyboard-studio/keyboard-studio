...
interface RawKey {
  ...
  hint?: string;
  /**
   * Free-text `layer` annotation (see `TouchKeyIR.layerAnnotation`), and also
   * the per-key modifier override (spec 058 FR-030, see `TouchKeyIR.layer`).
   * Both IR fields are populated from this one wire property.
   */
  layer?: string;
  /**
