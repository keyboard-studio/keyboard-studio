...
import { definition, fixtures } from "../../../../src/survey/questions/f/pf_example_words.ts";

describe("pf_example_words — definition", () => {
  it("has correct id", () => {
    expect(definition.id).toBe("pf_example_words");
  });
  it("is not required", () => {
  ...
  it("routes to pf_troubleshooting", () => {
    expect(definition.next).toBe("pf_troubleshooting");
  });
  it("has help text", () => {
...
describe("pf_example_words — fixtures (no validate)", () => {
