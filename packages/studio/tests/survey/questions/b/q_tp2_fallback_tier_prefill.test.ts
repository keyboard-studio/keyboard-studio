// Mirror test for the reserve adaptation module q_tp2_fallback_tier_prefill (spec 038). The module is a
...
import { validate, fixtures } from "../../../../src/survey/questions/b/q_tp2_fallback_tier_prefill.ts";

describe("q_tp2_fallback_tier_prefill — validate() valid fixtures", () => {
...
describe("q_tp2_fallback_tier_prefill — validate() invalid fixtures", () => {
...
describe("q_tp2_fallback_tier_prefill — validate() edge cases", () => {
