// Mirror test for the reserve adaptation module q_sa2_base_script_mismatch (spec 038). The module is a
...
import { validate, fixtures } from "../../../../src/survey/questions/b/q_sa2_base_script_mismatch.ts";

describe("q_sa2_base_script_mismatch — validate() valid fixtures", () => {
...
describe("q_sa2_base_script_mismatch — validate() invalid fixtures", () => {
...
describe("q_sa2_base_script_mismatch — validate() edge cases", () => {
