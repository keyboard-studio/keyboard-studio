// Mirror test for the reserve adaptation module q_tp3_orthography_join (spec 038). The module is a
...
import { validate, fixtures } from "../../../../src/survey/questions/b/q_tp3_orthography_join.ts";

describe("q_tp3_orthography_join — validate() valid fixtures", () => {
...
describe("q_tp3_orthography_join — validate() invalid fixtures", () => {
...
describe("q_tp3_orthography_join — validate() edge cases", () => {
