// Mirror test for the reserve adaptation module q_sa1_target_script_spread (spec 038). The module is a
...
import { validate, fixtures } from "../../../../src/survey/questions/b/q_sa1_target_script_spread.ts";

describe("q_sa1_target_script_spread — validate() valid fixtures", () => {
...
describe("q_sa1_target_script_spread — validate() invalid fixtures", () => {
...
describe("q_sa1_target_script_spread — validate() edge cases", () => {
