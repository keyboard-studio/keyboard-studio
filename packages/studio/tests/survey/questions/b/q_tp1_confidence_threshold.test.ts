// Mirror test for the reserve adaptation module q_tp1_confidence_threshold (spec 038). The module is a
...
import { validate, fixtures } from "../../../../src/survey/questions/b/q_tp1_confidence_threshold.ts";

describe("q_tp1_confidence_threshold — validate() valid fixtures", () => {
...
describe("q_tp1_confidence_threshold — validate() invalid fixtures", () => {
...
describe("q_tp1_confidence_threshold — validate() edge cases", () => {
