// Mirror test for the reserve adaptation module q_ip3_keep_script_conventions (spec 038). The module is a
...
import { validate, fixtures } from "../../../../src/survey/questions/b/q_ip3_keep_script_conventions.ts";

describe("q_ip3_keep_script_conventions — validate() valid fixtures", () => {
...
describe("q_ip3_keep_script_conventions — validate() invalid fixtures", () => {
...
describe("q_ip3_keep_script_conventions — validate() edge cases", () => {
