// Mirror test for the reserve adaptation module q_ip1_keep_strategies (spec 038). The module is a
...
import { validate, fixtures } from "../../../../src/survey/questions/b/q_ip1_keep_strategies.ts";

describe("q_ip1_keep_strategies — validate() valid fixtures", () => {
...
describe("q_ip1_keep_strategies — validate() invalid fixtures", () => {
...
describe("q_ip1_keep_strategies — validate() edge cases", () => {
