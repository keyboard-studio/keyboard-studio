// Mirror test for the reserve adaptation module q_ip2_keep_device_targets (spec 038). The module is a
...
import { validate, fixtures } from "../../../../src/survey/questions/b/q_ip2_keep_device_targets.ts";

describe("q_ip2_keep_device_targets — validate() valid fixtures", () => {
...
describe("q_ip2_keep_device_targets — validate() invalid fixtures", () => {
...
describe("q_ip2_keep_device_targets — validate() edge cases", () => {
