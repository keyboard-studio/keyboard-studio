 ...
 * pitfall the "merges a pre-existing duplicate pair" cases below warn about).
 */
...
//
// Both cases in this describe seed the STALE row (the one the merge is about to delete)
