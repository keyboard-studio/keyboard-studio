...
// spec 080 FR-008: one label/tone mapping shared with MetadataCard's badge.
...
export function BaseResolution({
  ...
  // spec 080 FR-008: classify the focused/previewed base's documentation
          ...
          {suggestions.map(({ base, reason, relative }) => {
            ...
            >
              ...
              <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
                {/* spec 080 FR-008: documentation-completeness badge — rendered
