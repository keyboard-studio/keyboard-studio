...
export {
  ...
  parseTargetTokens,
  // spec 079 FR-002 — the welcome page's folder-convention member reference.
...
export {
  ...
  renderWelcomeHtm,
  renderHelpPhp,
  // spec 079 FR-003 — the standard help-site header a fresh help page opens with.
  helpSiteHeader,
  helpSitePageName,
  helpPhpStub,
  // spec 079 FR-004/FR-006 — the welcome page's layout section and the pure
...
// spec 079 FR-022 — the one derivation of each documentation member's source
...
// spec 079 FR-010..012 — the HISTORY proposal built from the decision record
...
// spec 079 FR-013..016 — deterministic SVG layout charts (research R1/R2).
export {
  renderLayoutCharts,
  layoutChartFilename,
  LAYOUT_CHART_PREFIX,
...
// spec 079 FR-008/FR-009 — base documentation classification (research R4).
