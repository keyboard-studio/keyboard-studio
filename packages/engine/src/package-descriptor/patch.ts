...
// exactly as it finds them. The single exception is spec 080 FR-002: a produced
// package MUST ship its welcome page at `source/welcome/welcome.htm` and MUST NOT
// ship a flat `source/welcome.htm`, so a pre-080 descriptor (the copy track's
 ...
 * ONE exception of the welcome-path migration (spec 080 FR-002; see the module
...
/**
 * The welcome-path migration (spec 080 FR-002). Pure.
 *
