...
export function generateStubs(
  ...
  const stubs: Array<{ path: string; content: string | Uint8Array; isBinary?: boolean }> = [
    ...
    {
      // spec 080 FR-002: the folder convention, never the flat `source/welcome.htm`.
    ...
    },
    {
      ...
      // spec 080 FR-003: standard help-site header + the placeholder comment,
    ...
    },
    {
      ...
      // this on every production through renderHistoryMd (spec 080 US5), which
  ...
  return {
    ...
    async scaffold(
      ...
      try {
        ...
        // spec 080 R9: a Track 1 copy inherits the base's welcome IMAGES (and
      ...
      return {
        ...
        // spec 080 FR-006/R9: the base's welcome images, for the copy's own
