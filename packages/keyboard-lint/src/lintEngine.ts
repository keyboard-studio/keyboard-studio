...
//                    18.13 KM_WARN_TOUCH_REPLACE_SHADOWS_ALTERNATE
...
//
// The locked LintEngineService.lint() interface runs 18.1–18.5 and 18.13 only (no compiled
// artefacts needed). Callers that have a KeyboardIR + LinguistInventory (e.g. the compile
// gate) should call lintWithContext() directly from lintContext.ts.
 ...
 * Runs the touch-layout checks (18.1–18.5, 18.13) via the locked `lint()` contract.
