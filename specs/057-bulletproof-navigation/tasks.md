...
- [ ] **T073** Restart `pnpm dev`, then run the full E2E suite deliberately and report it with its output — a green run is a named prerequisite for closing this feature, not an assumption (FR-081, SC-013) · `specs/057-bulletproof-navigation/evidence/e2e-green.md`

**⟶ Wait for T073, then:**

- [ ] **T074** Validate every Success Criterion SC-001…SC-014 against the recorded evidence, naming the test or run that establishes each · `specs/057-bulletproof-navigation/evidence/success-criteria.md`
