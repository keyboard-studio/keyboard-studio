...
**Parallel opportunities**: the largest independent waves are Phase 3 Wave 2 (T010/T011/T012/T013 — engine worklist, studio station, spec 071, output-form policy: four different files, no shared dependency) and Phase 5 Wave 4 (T026–T030 — contracts schemas/axes/barrel and the two facet-index files). Phase 7 Wave 1 is fully independent.
