...
- [specs/073-flow-question-i18n/spec.md](../073-flow-question-i18n/spec.md) — the `content/i18n/en/flowQuestions.json` catalog and its `content.flowQuestion.<id>.<field>` key convention. Any new author-facing per-question text belongs there, extracted by `utilities/i18n-content-extract`, not hand-maintained.
