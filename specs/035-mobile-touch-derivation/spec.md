...
- [editors/assignLoop/TouchGallery.tsx](../../packages/studio/src/editors/assignLoop/TouchGallery.tsx) seeds from a **fixed minimal QWERTY** and states in its own header comment that "desktop edits are NOT transferred to mobile." So the author's carve removals and desktop letter placements do not reach the touch layout.
