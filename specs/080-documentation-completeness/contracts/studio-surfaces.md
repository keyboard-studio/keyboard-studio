# Contract: Studio surfaces (spec 080, FR-017 / FR-021 / Article IX)
...
- **Manifest**: display-only addition to the existing editor step; `specRef` gains
  `specs/080-documentation-completeness`. No writes.
...
- **Manifest**: question module declares `inputs: []`, `writes: []` (store-slice
  pattern per spec 061 precedent), `specRef: "specs/080-documentation-completeness"`.
