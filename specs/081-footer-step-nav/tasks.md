...
- [X] T058 Reconcile #1778's acceptance-criteria checkboxes against the shipped diff (CLAUDE.md issue closure policy), then hand off to `km-archivist` to open the PR against `main` with `refs #1778` or `closes #1778`. Do not merge
