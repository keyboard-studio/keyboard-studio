...
1. **vitest unit tests** — for `packages/contracts/`, `packages/engine/` (including its `src/scaffolder/` and `src/validator/` modules), etc. Keeps the 101+ baseline specs green and grows them with each contract change.
